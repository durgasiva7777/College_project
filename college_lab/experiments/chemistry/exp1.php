...
<body>
    <div class="container">
        <!-- Main Form -->
        <form id="exp1-form" method="post" action="../../submit_experiment.php" class="form-section">
            ...
            <h2>Introduction To Chemistry Laboratory</h2>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <div style="margin: 12px 0;">
                            <img src="../../images/exp1.jpg" alt="Quinonoid form 1" style="max-width: 100%; height: auto;" />
                        </div>
                        ...
                        <div style="margin: 12px 0;">
                            <img src="../../images/exp1_2.jpg" alt="Quinonoid form 2" style="max-width: 100%; height: auto;" />
                        </div>
                    </li>
                </ol>
            </div>
    ...
    <script>
        ...
        // Static content HTML
        const staticContent = document.getElementById('experiment-content').innerHTML;
