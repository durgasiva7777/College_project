...
<body>
  <div class="container">
    <!-- Main Form -->
    <form id="exp8-form" method="post" action="submit_experiment.php" class="form-section">
      ...
      <div style="text-align:center; margin-top:10px;">
        <img src="../../exp8.jpg" alt="Graph Image" style="max-width:100%; height:auto; border:1px solid #ccc; padding:5px;" />
      </div>
  ...
  <script>
    ...
    function submitExperiment() {
      const form = document.getElementById('exp8-form');
      const expNo = form.experiment_id.value.trim();
