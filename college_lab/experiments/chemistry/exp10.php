...
<head>
  ...
  <title>Experiment 10: WAVELENGTH MESASUREMENT OF SAMPLE THROUGH UV-VISIBLE SPECTROSCOPY</title>
...
<body>
  <div class="container">
    <!-- Main Form -->
    <form id="exp10-form" method="post" class="form-section">
      ...
      <textarea id="principle" name="principle" rows="3" placeholder="Explain principle" style="width: 100%; display: block; overflow: auto; resize: none; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"></textarea>

      <label for="instrument">Instrument</label>
      <textarea id="instrument" name="instrument" rows="3" placeholder="Explain instrument" style="width: 100%; display: block; overflow: auto; resize: none; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"></textarea>

      <label for="Double_beam">Illutration of a Double Beam UV - Vis Instrument :</label>
      <textarea id="Double_beam" name="Double_beam" rows="3" placeholder="Explain Illutration of a Double Beam UV - Vis Instrument" style="width: 100%; display: block; overflow: auto; resize: none; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"></textarea>

      <div style="text-align:center; margin-top:10px;">
        <img src="../../images/exp10_1.png" alt="Graph Image" style="max-width:100%; height:auto; border:1px solid #ccc; padding:5px;" />
      </div>

      <h3>Procedure :</h3>
      <textarea id="procedure_a" name="procedure_a" rows="4" placeholder="Enter Procedure" style="width: 100%; display: block; overflow: auto; resize: none; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"></textarea>

      <div style="text-align:center; margin-top:10px;">
        <img src="../../images/exp10_2.png" alt="Graph Image" style="max-width:100%; height:auto; border:1px solid #ccc; padding:5px;" />
      </div>
    ...
    <aside class="sidebar">
      <div class="apparatus-box">
        ...
        <div class="apparatus-list">
          <button type="button" class="apparatus-btn">SPECTROPHOTOMETER</button>
          ...
          <button type="button" class="apparatus-btn">100 ml Beaker</button>
  ...
  <script>
    ...
    <h2 style="text-align:center; margin-top: 0;">WAVELENGTH MESASUREMENT OF SAMPLE THROUGH UV-VISIBLE SPECTROSCOPY</h2>
    ...
    <p><b>Instrument:</b> ${formatTextWithBreaks(form.instrument.value || '')}</p>
    <p><b>Illutration of a Double Beam UV - Vis Instrument:</b> ${formatTextWithBreaks(form.Double_beam.value || '')}</p>
    ...
    <p><b>Result:</b> ${formatTextWithBreaks(form.result.value || '')}</p>`;
        ...
        win.document.write('<!DOCTYPE html><html><head><title>Preview - Experiment 10</title><meta charset="utf-8"></head><body>');
