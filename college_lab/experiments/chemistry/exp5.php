...
<head>
  ...
  <title>Experiment 5: CONDUCTOMETRIC TITRATION (STRONG ACID Vs STRONG BASE)</title>
...
<body>
  <div class="container">
    <!-- Main Form -->
    <form id="exp5-form" method="post" action="submit_experiment.php" class="form-section">
      ...
      <h2 style="font-size: 30px;">CONDUCTOMETRIC TITRATION (STRONG ACID Vs STRONG BASE)</h2>
      ...
      <h3>Procedure - Part B: Estimation of HCl</h3>
      <textarea id="procedure_b" name="procedure_b" rows="4" placeholder="Enter Procedure Part B" required></textarea>

      <h4>Conductometric Titration Data</h4>
      <table id="conductivity-table">
        <tr>
          <th>S.No</th>
          <th>Volume of NaOH Added (ml)</th>
          <th>Observed Conductance (µS/cm)</th>
          <th>Corrected Conductance<br>G = ((u + v)/u)c</th>
        </tr>
        <tr><td>1</td><td><input type="text" name="est_v1" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance1" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_1" step="0.1" /></td></tr>
        <tr><td>2</td><td><input type="text" name="est_v2" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance2" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_2" step="0.1" /></td></tr>
        <tr><td>3</td><td><input type="text" name="est_v3" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance3" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_3" step="0.1" /></td></tr>
        <tr><td>4</td><td><input type="text" name="est_v4" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance4" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_4" step="0.1" /></td></tr>
        <tr><td>5</td><td><input type="text" name="est_v5" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance5" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_5" step="0.1" /></td></tr>
        <tr><td>6</td><td><input type="text" name="est_v6" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance6" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_6" step="0.1" /></td></tr>
        <tr><td>7</td><td><input type="text" name="est_v7" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance7" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_7" step="0.1" /></td></tr>
        <tr><td>8</td><td><input type="text" name="est_v8" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance8" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_8" step="0.1" /></td></tr>
        <tr><td>9</td><td><input type="text" name="est_v9" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance9" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_9" step="0.1" /></td></tr>
        <tr><td>10</td><td><input type="text" name="est_v10" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance10" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_10" step="0.1" /></td></tr>
        <tr><td>11</td><td><input type="text" name="est_v11" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance11" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_11" step="0.1" /></td></tr>
        <tr><td>12</td><td><input type="text" name="est_v12" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance12" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_12" step="0.1" /></td></tr>
        <tr><td>13</td><td><input type="text" name="est_v13" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance13" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_13" step="0.1" /></td></tr>
        <tr><td>14</td><td><input type="text" name="est_v14" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance14" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_14" step="0.1" /></td></tr>
        <tr><td>15</td><td><input type="text" name="est_v15" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance15" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_15" step="0.1" /></td></tr>
        <tr><td>16</td><td><input type="text" name="est_v16" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance16" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_16" step="0.1" /></td></tr>
        <tr><td>17</td><td><input type="text" name="est_v17" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance17" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_17" step="0.1" /></td></tr>
        <tr><td>18</td><td><input type="text" name="est_v18" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance18" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_18" step="0.1" /></td></tr>
        <tr><td>19</td><td><input type="text" name="est_v19" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance19" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_19" step="0.1" /></td></tr>
        <tr><td>20</td><td><input type="text" name="est_v20" class="volume-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_conductance20" class="conductance-input" step="0.1" onchange="updateGraph()" /></td><td><input type="text" name="est_vol_k2_20" step="0.1" /></td></tr>
      </table>
      ...
      <div class="graph-section">
        ...
        <div id="graph-placeholder" style="text-align: center; padding: 40px; color: #666; background: #f9f9f9; border-radius: 5px;">
          ...
          <p>Enter Volume of NaOH and Observed Conductance values to generate the titration curve</p>
        </div>
      ...
      <div class="calculation-box">
        ...
        <div class="calc-row">
          <label for="calc_est_n2">N₃ = Normality of HCl solution =</label>
          <input type="text" id="calc_est_n2" name="calc_est_n2" />
        </div>
        <div class="calc-row">
          <label for="calc_est_v1">V₂ = Volume of NaOH solution at endpoint =</label>
          <input type="text" id="calc_est_v1" name="calc_est_v1" />
        </div>
        <div class="calc-row">
          <label for="calc_est_v2">V₃ = Volume of HCl solution =</label>
          <input type="text" id="calc_est_v2" name="calc_est_v2" value="25" />
        </div>
        ...
        <div class="result-text">Normality of HCl solution (N₃) is <input type="text" id="calc_est_n3_final" name="calc_est_n3_final" style="width: 110px;" /> N.</div>

        <div class="calc-row">
          <label for="calc_est_amount">Amount of HCl present in given solution is </label>
        </div>
        ...
        <div class="result-text" style="display:block;">
          Where: E = Gram equivalent weight of HCl = <input type="text" id="calc_est_e" name="calc_est_e" readonly value="36.5" style="width: 80px;" /> grams<br />
          N = Normality of HCl solution (N₃) = <input type="text" id="calc_est_n_val" name="calc_est_n_val" style="width: 100px;" /><br />
          V = Volume of HCl solution = <input type="text" id="calc_est_v_val" name="calc_est_v_val" style="width: 100px;" value="25" />
        </div>
      </div>
  ...
  <script>
    ...
    function updateGraph() {
      ...
      for (let i = 1; i <= 20; i++) {
        ...
        const conductanceInput = document.querySelector(`input[name="est_conductance${i}"]`);
      ...
      titrationChart = new Chart(ctx, {
        ...
        options: {
          ...
          plugins: {
            title: {
              display: true,
              text: 'Conductometric Titration: HCl vs NaOH',
              font: {
                size: 16,
                weight: 'bold'
              },
    ...
    function generateCurveFromUserData(inputVolumes, inputConductances) {
      ...
      if (volumes.length >= 2) {
        // Find the equivalence point (minimum point for strong acid-strong base)
    ...
    function createPrintStyleGraph(volumes, conductances, width = 600, height = 400) {
      ...
      ctx.fillText('Conductometric Titration: HCl vs NaOH', width / 2, 30);
...
<h2 style="text-align:center; margin-top: 0;">CONDUCTOMETRIC TITRATION (STRONG ACID Vs STRONG BASE)</h2>
...
<div>
  ...
  N₃: Normality of HCl solution = ${escapeHtml(form.calc_est_n2.value || '')}<br><br>
  V₂: Volume of NaOH solution at endpoint = ${escapeHtml(form.calc_est_v1.value || '')} ml<br><br>
  V₃: Volume of HCl solution = ${escapeHtml(form.calc_est_v2.value || '25')} ml<br><br>
  Formula: N₂V₂ = N₃V₃<br><br>
  N₃ = (N₂V₂) / V₃ = ${escapeHtml(form.calc_est_n3_calc.value || '')}<br><br>
  Normality of HCl solution (N₃) is ${escapeHtml(form.calc_est_n3_final.value || '')} N<br><br>
  Amount of HCl present in given solution is ${escapeHtml(form.calc_est_amount?.value || '')}<br><br>
  Q = (E × N₃ × Volume in ml) / 1000 = ${escapeHtml(form.calc_est_q.value || '')} g/1000ml<br><br>
  Where:<br><br>
  E = Gram equivalent weight of HCl = ${escapeHtml(form.calc_est_e.value || '36.5')} grams<br><br>
  N = Normality of HCl solution (N₃) = ${escapeHtml(form.calc_est_n_val.value || '')} N<br><br>
  V = Volume of HCl solution = ${escapeHtml(form.calc_est_v_val.value || '25')} ml
</div>
...
<h3>Result :</h3><p>${formatTextWithBreaks(form.result.value || '')}</p>`;
  ...
  if (graphDataURL) {
    postData.append('graph_data', graphDataURL);
  }
