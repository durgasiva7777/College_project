...
<body>
  <div class="container">
  <!-- Main Form -->
  <form id="exp2-form" method="post" action="submit_experiment.php" class="form-section">
  ...
  <div style="margin-top: 12px;">
    <img src="../../exp_2.png" alt="Principle equations" style="max-width: 100%; height: auto;" />
  </div>
...
<div style="text-align:center; font-weight: 700; font-size: 1.3rem; margin: 15px 0 30px;">
  ${escapeHtml(form.expName?.value || '')}
</div>
...
<div style="margin:12px 0;"><img src="../../exp_2.png" alt="Principle equations" style="max-width:100%;height:auto;"></div>
