...
<body>
  <div class="container">
    <!-- Main Form -->
   <form id="exp2-form" method="post" onsubmit="event.preventDefault(); submitExperiment();" class="form-section">
      <!-- Experiment Header -->
    ...
    <tr>
        ...
        <th >Whirling Speed<br> In (rpm)</th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td><input type="text" name="diameter1"></td>
                    <td><input type="text" name="end_condition1"></td>
                    <td><input type="text" name="whirling_speed1"></td>
                </tr>
            </tbody>
        </table>
      <br>
      <h4>Formula :</h4>
      <div class="calc-row">
           <label for="calc_std_n" style="text-align: left;">Fundamental frequency of transverse vibrations(f) =  f = &radic;(E . I . g / W . L<sup>4</sup>) =</label><br><br><br>
           <textarea name="Fundamental_frequency" id="Fundamental_frequency" placeholder="Calculations Hear "></textarea>
          ...
          <label for="calc_std_n1">Length of the Shaft (V) =</label>
          <input type="text" id="calc_std_n1" name="calc_std_n1" /><p><b>m</b></p>
      </div>
<div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
    <p style="text-align: center; margin: 0;"><b>Theorical Critical speed = f * 60 =</b></p>
...
<table border="1" cellspacing="0" cellpadding="5" style="width:100%; border-collapse: collapse;">
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>${escapeHtml(form.diameter1?.value || '')}</td>
            <td>${escapeHtml(form.end_condition1?.value || '')}</td>
            <td>${escapeHtml(form.whirling_speed1?.value || '')}</td>
        </tr>
    </tbody>
</table>
...
function submitExperiment() {
    ...
    if (!form.aim.value.trim() || !form.theory.value.trim() || !form.procedure.value.trim() || 
