...
<body>
  <div class="container">
    <!-- Main Form -->
    <form id="exp3-form" method="post" onsubmit="event.preventDefault(); submitExperiment();" class="form-section">
...
function submitExperiment() {
    ...
    if (!form.aim.value.trim() || !form.theory.value.trim() || !form.definitions.value.trim() || 
        !form.Procedure.value.trim() || !form.result.value.trim()) {
